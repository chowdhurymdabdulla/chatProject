...
| bs          | &{border-style:{value}}                  |             | {value:camelCase}                                |                    |
| bc          | &{border-color:{value}}                  |             | {value:camelCase/([A-F0-9]+)}                    | #000 (0)           |
...
| c           | &{color:{value}}                         |             | {value:camelCase/([A-F0-9]+)}                    | #000 (0)           |
| stroke      | &{stroke:{value}}                        |             | {value:camelCase/([A-F0-9]+)}                    | #000 (0)           |
| bg          | &{background:{value}}                    |             | [ ...-?{value:camelCase/([A-F0-9]+)}{unit:(p/w)}{position:([0-9]+)} ]-?{(r_{method:(.*)})/g{angle:(-?[0-9]+)})}  | #000 (0)           |
...
| fw          | &{font-weight:{value is camelCase ? value : value *100}} |             | {value:camelCase/([A-F0-9]+)}      | 100 (1)             |
